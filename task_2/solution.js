function calcShipping(sum, min, shipping) {
    ...
    if (freeShippingMinSum > productsSum && productsSum > 0) {shippingSum = shippingPrice}
...
function calcDiscount(sum, min, discount) {
    ...
    if (productsSum >= discountMinSum) {discountSum = (productsSum/100)*discountPart} else {discountSum = 0};
